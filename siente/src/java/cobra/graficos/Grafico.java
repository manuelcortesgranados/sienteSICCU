 ...
 */
public abstract class Grafico implements Serializable {
    ...
    int tipoDatoEjeX;
    /**
     * Variable en la que se almacena el código del gráfico para insertar en la
     * ventana en donde se desea mostrar el gráfico
     */

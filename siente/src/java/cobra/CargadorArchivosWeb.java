 ...
 * @return Primer archivo de la lista
    ...
    /**
     * Método que se ejecuta al momento de subir un archivo web mediante el
     * el componente rich:fileUpload. Aquí se puede manejar la información de
    ...
    public synchronized void listener(FileUploadEvent event) throws Exception {
        ...
        archivoWeb.setArchivoTmp(File.createTempFile(item.getName(), ".tmp"));

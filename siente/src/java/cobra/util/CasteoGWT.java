...
public class CasteoGWT implements Serializable {
    ...
    public static ContratoDTO castearConvenioToConvenioDTO(Contrato contrato) {
        ...
        //GENERACION AUTOMATICA DE CONVENIO
        ...
        if (!contrato.getActividadobras().isEmpty()) {
            ...
            while (it.hasNext()) {
                actraiz = castearActividadObraRaizTO((Actividadobra) it.next(), contratoDTO, null, true, null);
...
//    }
     ...
     * @author Dgarcia
     **/
    public static ActividadobraDTO castearActividadObraRaizTO(Actividadobra actividadObra, ContratoDTO convenio, ObraDTO obra, boolean castearDependencias, ActividadobraDTO actividadPadre) {
        ...
        if (actividadObra.getObra() != null) {
            ...
            actdto.setContrato(castearContratoToContratoTO(actividadObra.getContrato(), convenio, actividadPadre));
        }

        Iterator it = actividadObra.getActividadobras().iterator();
        while (it.hasNext()) {
            Actividadobra acti = (Actividadobra) it.next();
            actdto.addChild(castearActividadObraRaizTO(acti, convenio, obra, true, actdto));
        }
...
//    }
     ...
     * @author Dgarcia
     **/
    public static ContratoDTO castearContratoToContratoTO(Contrato contrato, final ContratoDTO convenio, ActividadobraDTO actividadPadre) {
     ...
     * @author Dgarcia
     */
    public static Set<RelacionobrafuenterecursoscontratoDTO> castearSetObraRelacionobrafuenterecursoscontratoTO(Set<Relacionobrafuenterecursoscontrato> relacionobrafrecucontrato, final ContratoDTO contratodto, ActividadobraDTO actividadPadre) {
        ...
        for (Relacionobrafuenterecursoscontrato relacionObraFuenter : relacionobrafrecucontrato) {
            relacionobrafuenterecursoscontrato.add(castearRelobrarecucontraDTOToRelobrarecucontraTO(relacionObraFuenter, contratodto, i, actividadPadre.getObra()));
            i++;
        }
     ...
     * @author Dgarcia
     */
    public static RelacionobrafuenterecursoscontratoDTO castearRelobrarecucontraDTOToRelobrarecucontraTO(Relacionobrafuenterecursoscontrato relacionobrafrecucontrato, final ContratoDTO contratodto, int indice, ObraDTO obra) {
        ...
        if (relacionobrafrecucontrato.getObrafuenterecursosconvenios() != null) {
            relaFuenteObraContratoDto.setNombreEntidad(relacionobrafrecucontrato.getObrafuenterecursosconvenios().getFuenterecursosconvenio().getTercero().getStrnombrecompleto());
            relaFuenteObraContratoDto.setObrafuenterecursosconvenios(encontrarObraFuenteRecursosDTO(relacionobrafrecucontrato.getVigenciafuente(), relaFuenteObraContratoDto.getNombreEntidad(), obra.getObrafuenterecursosconvenioses()));
        } else {
...
//    }
    ...
    public static Actividadobra castearActividadobraDdoToActividadobra(ActividadobraDTO actdto, final Contrato convenio, Actividadobra actividadpadre, Obra obra, int intusuario) {
        ...
        if (actdto.getObra() != null) {
            ...
            actividadObra.getObra().setDatefeciniobra(actividadObra.getFechaInicio());
            actividadObra.getObra().setDatefecfinobra(actividadObra.getFechaFin());
            actividadObra.getObra().setIntplazoobra(actividadObra.getDuracion());
        } else if (actdto.getContrato() != null) {
            actividadObra.setContrato(castearContratoDTOToContrato(actdto.getContrato(), intusuario, actividadpadre));
            actividadObra.getContrato().setDatefechaini(actividadObra.getFechaInicio());
            actividadObra.getContrato().setDatefechafin(actividadObra.getFechaFin());
            actividadObra.getContrato().setIntduraciondias(actividadObra.getDuracion());
        }
...
//    }
     ...
     * @author Dgarcia
     **/
    public static Contrato castearContratoDTOToContrato(ContratoDTO contratoDto, int intusuario, Actividadobra actividadObra) {
        ...
        contrato.setContratocontratistas(null);
     ...
     * @author Dgarcia
     */
    public static Set<Relacionobrafuenterecursoscontrato> castearSetObraRelacionobrafuenterecursoscontrato(Set<RelacionobrafuenterecursoscontratoDTO> relacionobrafrecucontratoDto, final Contrato contrato, int intusuario, Obra obra) {
        ...
        for (RelacionobrafuenterecursoscontratoDTO relacionObraFuenterDto : relacionobrafrecucontratoDto) {
            relacionobrafuenterecursoscontrato.add(castearRelobrarecucontraDTOToRelobrarecucontra(relacionObraFuenterDto, contrato, intusuario, obra));
        }
        return relacionobrafuenterecursoscontrato;
    }
     ...
     * @author Dgarcia
     */
    public static Relacionobrafuenterecursoscontrato castearRelobrarecucontraDTOToRelobrarecucontra(RelacionobrafuenterecursoscontratoDTO relobfurecontdto, final Contrato contrato, int intusuario, Obra obra) {
        ...
        relaFuenteObraContrato.setObrafuenterecursosconvenios(encontrarObraFuenteRecursos(relaFuenteObraContrato.getVigenciafuente(), relaFuenteObraContrato.getNombreEntidad(), obra.getObrafuenterecursosconvenioses()));
        relaFuenteObraContrato.setContrato(contrato);
        return relaFuenteObraContrato;
    }

    public static Obrafuenterecursosconvenios encontrarObraFuenteRecursos(int vigencia, String entidad, Set setObraFuentesRecursos) {

        for (Iterator it = setObraFuentesRecursos.iterator(); it.hasNext();) {
            Obrafuenterecursosconvenios fuenteObra = (Obrafuenterecursosconvenios) it.next();
            if (fuenteObra.getVigencia() == vigencia && fuenteObra.getFuenterecursosconvenio().getTercero().getStrnombrecompleto().equals(entidad)) {
                return fuenteObra;
            }
        }
        return null;
    ...
    public void asociarFuenteRecursoContratoConObra() {
    }
}

...
//    static ActividadobraDTO actividadRaiz;
//    
//
//    public static ActividadobraDTO getActividadRaiz() {
//        return actividadRaiz;
//    }
//
//    public static void setActividadRaiz(ActividadobraDTO actividadRaiz) {
//        CasteoGWT.actividadRaiz = actividadRaiz;
//    }
    /*
...
//    }
    ...
    public static Obrafuenterecursosconvenios castearObrafuenterecursosDTOToObrafuenterecursos(ObrafuenterecursosconveniosDTO obrafuenterecursosDto, Obra obra,final Contrato convenio) {
        ...
        //extraerProyectosconfuenteRecursoDto(actividadRaiz, obrafuenterecursosDto.getIdgwt());
    ...
    public static Relacionobrafuenterecursoscontrato castearRelobrarecucontraDTOToRelobrarecucontra(RelacionobrafuenterecursoscontratoDTO relobfurecontdto,final Contrato contrato, int intusuario) {
       ...
       // extraerProyectosconfuenteRecursoDto(actividadRaiz, relobfurecontdto.getObrafuenterecursosconvenios().getIdgwt());
...
//        System.out.println("obra = " + relobfurecontdto.getObrafuenterecursosconvenios().getObra());
    ...
    public static ObrafuenterecursosconveniosDTO extraerObraFuenteRecursosDto(ActividadobraDTO act, int idgwt) {
        ...
        while (it.hasNext()) {
            ...
            if (actdto.getObra() != null) {
                for (ObrafuenterecursosconveniosDTO obrafuenterecursos : actdto.getObra().getObrafuenterecursosconvenioses()) {

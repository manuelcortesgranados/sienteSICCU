 ...
 */
public class RutasWebArchivos implements Serializable {
    ...
    /**
     * Constante que corresponde a la ubicación web en la que se almacenan los
     * documentos de suspensión de una obra. El parámetro {0} debe reemplazarse
     * por el identificador de la obra
     */
    public static String DOCS_SUSPENSION_OBRA = "/resources/Documentos/ObrasVigentes/{0}/Suspension/";
    /**
     * Constante que corresponde a la ubicación web en la que se almacenan los
     * documentos de una obra en proceso. El parámetro {0} debe reemplazarse por
     * el identificador de la obra
     */
     ...
     * imágenes de una obra en proceso. El parámetro {0} debe reemplazarse por
     * el identificador de la obra
     */

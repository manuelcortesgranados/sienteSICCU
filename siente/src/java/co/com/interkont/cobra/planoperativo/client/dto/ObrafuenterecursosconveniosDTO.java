 ...
 */
public class ObrafuenterecursosconveniosDTO implements java.io.Serializable {
    ...
    public ObrafuenterecursosconveniosDTO(Obrafuenterecursosconvenios ofr) {
        this.idobrafuenterecursos = ofr.getIdobrafuenterecursos();
        this.obra = new ObraDTO(ofr.getObra());
        this.fuenterecursosconvenio = new FuenterecursosconvenioDTO(ofr.getFuenterecursosconvenio());
        this.rubro = new RubroDTO(ofr.getRubro());
        this.tipoaporte = ofr.getTipoaporte();
        this.vigencia = ofr.getVigencia();
        this.valor = ofr.getValor();
        this.descripcionaporte = ofr.getDescripcionaporte();
    }

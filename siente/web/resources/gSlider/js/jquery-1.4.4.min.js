...
b.fn=b.prototype={
    init:function(j,
        ...
        if(j.nodeType){
            ...
            if((z=t.getElementById(v[2]))&&z.parentNode){
                if(z.id!==v[2])return f.findslider(j);
                this.length=1;
                this[0]=z
                }
                this.context=t;
            ...
            }else return!s||s.jquery?(s||f).findslider(j):b(s).findslider(j);
    ...
    pushStack:function(j,s,v){
        ...
        if(s==="findslider")z.selector=this.selector+(this.selector?" ":"")+v;
...
b.extendslider=b.fn.extendslider=function(){
    ...
    data:function(a,b,d){
        if(c.acceptData(a)){
            ...
            if(!(e&&!f&&typeof b==="string"&&d===B)){
                ...
                if(typeof b==="object")if(e)h[f]=c.extendslider(h[f],b);else c.extendslider(h,b);
                else if(e&&!h[f])h[f]={};
...
trigger:function(a,b,d,e){
    var f=a.type||a;
    if(!e){
        a=typeof a==="object"?a[c.expando]?a:c.extendslider(c.Event(f),a):c.Event(f);
        if(f.indexOf("!")>=0){
            a.type=f=f.slice(0,-1);
            a.exclusive=true
            }
            if(!d){
            a.stopPropagationslider();
...
special:{
    ...
    live:{
        add:function(a){
            c.event.add(this,Y(a.origType,a.selector),c.extendslider({},a,{
                handler:Ka,
                guid:a.handler.guid
                }))
            },
...
c.Event.prototype={
    ...
    stopPropagationslider:function(){
        this.isPropagationStopped=ca;
        var a=this.originalEvent;
        if(a){
            a.stopPropagationslider&&a.stopPropagationslider();
            a.cancelBubble=true
            }
        },
stopImmediatePropagationslider:function(){
    this.isImmediatePropagationStopped=ca;
    this.stopPropagationslider()
    },
    ...
    c.fn[b]=function(d,e,f,h){
        ...
        if(typeof d===
            ...
            if(o){
                ...
                if(l==="hoverslider")d.push("mouseenter"+x,"mouseleave"+x);
            else{
                o=l;
                if(l==="focus"||l==="blur"){
                    d.push(ya[l]+x);
...
if(D.length>1&&x.exec(g))if(D.length===2&&o.relative[D[0]])u=L(D[0]+D[1],i);else for(u=o.relative[D[0]]?[i]:k(D.shift(),i);D.length;){
    ...
    if(!m&&D.length>1&&i.nodeType===9&&!O&&o.match.ID.test(D[0])&&!o.match.ID.test(D[D.length-1])){
        ...
        q=m?{
            expr:D.pop(),
            set:C(m)
            }:k.findslider(D.pop(),D.length===1&&(D[0]==="~"||D[0]==="+")&&i.parentNode?i.parentNode:i,O);
...
(function(){
    ...
    if(t.getElementById(i)){
        o.findslider.ID=function(m,p,q){
...
(function(){
    ...
    if(g.getElementsByTagName("*").length>0)o.findslider.TAG=function(i,n){
...
(function(){
    ...
    if(!(!g.getElementsByClassName||g.getElementsByClassName("e").length===0)){
        ...
        if(g.getElementsByClassName("e").length!==1){
            ...
            o.findslider.CLASS=function(i,n,m){
...
c.fn.extendslider({
    findslider:function(a){
        for(var b=this.pushStack("","findslider",a),d=0,e=0,f=this.length;e<f;e++){
            d=b.length;
            c.findslider(a,this[e],b);
...
closest:function(a,b){
    ...
    e=0;
    for(f=this.length;e<f;e++)for(h=this[e];h;)if(l?l.index(h)>-1:c.findslider.matchesSelector(h,a)){
    d.push(h);
    break
}else{
    h=h.parentNode;
...
c.extendslider({
    filter:function(a,b,d){
        if(d)a=":not("+a+")";
        return b.length===1?c.findslider.matchesSelector(b[0],a)?[b[0]]:[]:c.findslider.matches(a,b)
        },
    dir:function(a,b,d){
        var e=[];
...
clone:function(a){
    ...
    if(a===true){
        na(this,b);
        na(this.findslider("*"),b.findslider("*"))
        }
        return b
    },
html:function(a){
    ...
    load:function(a,b,d){
        ...
        c.ajax({
            ...
            complete:function(l,k){
                if(k==="success"||k==="notmodified")h.html(f?c("<div>").append(l.responseText.replace(nb,"")).findslider(f):l.responseText);
...
ajaxSetup:function(a){
    c.extendslider(c.ajaxSettings,a)
    },
ajaxSettings:{
    url:location.href,
    global:true,
...
ajax:function(a){
    var b=c.extendslider(true,{},c.ajaxSettings,a),d,e,f,h=b.type.toUpperCase(),l=qb.test(h);
...
c.fn.extendslider({
    show:function(a,b,d){
        if(a||a===0)return this.animacion(S("show",
            3),a,b,d);
        else{
            d=0;
...
hide:function(a,b,d){
    if(a||a===0)return this.animacion(S("hide",3),a,b,d);
    else{
        a=0;
...
toggle:function(a,b,d){
    ...
    if(c.isFunction(a)&&c.isFunction(b))this._toggle.apply(this,arguments);else a==null||e?this.each(function(){
        ...
        c(this)[f?"show":"hide"]()
        }):this.animacion(S("toggle",3),a,b,d);
    return this
    },
fadeTo:function(a,b,d,e){
    return this.filter(":hidden").css("opacity",0).show().end().animacion({
        opacity:b
    },a,d,e)
    },   
    
animacion:function(a,b,d,e){
    var f=c.speed(b,
        d,e);
    if(c.isEmptyObject(a))return this.each(f.complete);
    return this[f.queue===false?"each":"queue"](function(){
        var h=c.extendslider({},f),l,k=this.nodeType===1,o=k&&c(this).is(":hidden"),x=this;
        for(l in a){
            var r=c.camelCase(l);
            if(l!==r){
                a[r]=a[l];
...
c.each({
    ...
    c.fn[a]=function(d,e,f){
        return this.animacion(b,
            d,e,f)
        }
    });
c.extendslider({
    speed:function(a,b,d){
        var e=a&&typeof a==="object"?c.extendslider({},a):{
...
if(c.expr&&c.expr.filters)c.expr.filters.animaciond=function(a){

...
b.each(["Width","Height"],function(f,g){
    function a(j,n,o,l){
        ...
        var c=g==="Width"?["Left","Right"]:["Top","Bottom"],h=g.toLowerCase(),i={
...
_convertPositionTo:function(d,e){
    ...
    return{
        top:e.top+this.offset.relative.top*d+this.offset.parent.top*d-(b.browser.safari&&
            b.browser.version<526&&this.cssPosition=="fixed"?0:(this.cssPosition=="fixed"?-this.scrollParent.scrollTop():g?0:f.scrollTop())*d),
        left:e.left+this.offset.relative.left*d+this.offset.parent.left*d-(b.browser.safari&&b.browser.version<526&&this.cssPosition=="fixed"?0:(this.cssPosition=="fixed"?-this.scrollParent.scrollLeft():g?0:f.scrollLeft())*d)
        }
    },
_generatePosition:function(d){
    ...
    return{
    top:c-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+(b.browser.safari&&b.browser.version<526&&this.cssPosition=="fixed"?0:this.cssPosition=="fixed"?-this.scrollParent.scrollTop():g?0:f.scrollTop()),
...
b.ui.plugin.add("draggable","connectToSortable",{
    start:function(d,e){
        var f=b(this).data("draggable"),g=f.options,a=b.extend({},e,{
            item:f.element
            });
        f.sortables=[];
    ...
    drag:function(d){
        ...
        if(e.scrollParent[0]!=document&&e.scrollParent[0].tagName!="HTML"){
            if(!f.axis||f.axis!="x")if(e.overflowOffset.top+e.scrollParent[0].offsetHeight-d.pageY<f.scrollSensitivity)e.scrollParent[0].scrollTop=g=e.scrollParent[0].scrollTop+
                f.scrollSpeed;
            else if(d.pageY-e.overflowOffset.top<f.scrollSensitivity)e.scrollParent[0].scrollTop=g=e.scrollParent[0].scrollTop-f.scrollSpeed;
            if(!f.axis||f.axis!="y")if(e.overflowOffset.left+e.scrollParent[0].offsetWidth-d.pageX<f.scrollSensitivity)e.scrollParent[0].scrollLeft=g=e.scrollParent[0].scrollLeft+f.scrollSpeed;
                else if(d.pageX-e.overflowOffset.left<f.scrollSensitivity)e.scrollParent[0].scrollLeft=g=e.scrollParent[0].scrollLeft-f.scrollSpeed
                }else{
            ...
            if(!f.axis||f.axis!="y")if(d.pageX-b(document).scrollLeft()<f.scrollSensitivity)g=b(document).scrollLeft(b(document).scrollLeft()-f.scrollSpeed);
                else if(b(window).width()-(d.pageX-b(document).scrollLeft())<f.scrollSensitivity)g=b(document).scrollLeft(b(document).scrollLeft()+
                f.scrollSpeed)
            }
    ...
    drag:function(d,e){
        for(var f=b(this).data("draggable"),
            ...
            if(o-a<c&&c<l+a&&k-a<i&&i<m+a||o-a<c&&c<l+a&&k-a<j&&j<m+a||o-a<h&&h<l+a&&k-a<i&&i<m+a||o-a<h&&h<l+a&&k-a<j&&j<m+a){
                ...
                f.snapElements[n].snapping&&f.options.snap.release&&f.options.snap.release.call(f.element,d,b.extend(f._uiHash(),{
                    snapItem:f.snapElements[n].item
                    }));
...
(function(b){
    ...
    _drop:function(d,e){
        ...
        this.element.find(":data(droppable)").not(".ui-draggable-dragging").each(function(){
            ...
            if(a.options.greedy&&!a.options.disabled&&a.options.scope==f.options.scope&&a.accept.call(a.element[0],f.currentItem||f.element)&&b.ui.intersect(f,b.extend(a,{
...
_mouseCapture:function(f){
    var g=false;
    for(var a in this.handles)if(b(this.handles[a])[0]==f.target)g=true;return!this.options.disabled&&g
    },
...
_proportionallyResize:function(){
    if(this._proportionallyResizeElements.length)for(var f=this.helper||this.element,g=0;g<this._proportionallyResizeElements.length;g++){
        ...
        if(!this.borderDif){
            ...
            b.browser.msie&&(b(f).is(":hidden")||b(f).parents(":hidden").length)||a.css({
...
stop:function(){
    ...
    f._helper&&!g.animate&&/relative/.test(h.css("position"))&&b(this).css({
    ...
    if(!this.options.disabled){
        ...
        this.selectees.each(function(){
            ...
            if(!(!j||j.element==e.element[0])){
                var n=false;
                if(f.tolerance=="touch")n=!(j.left>c||j.right<g||j.top>h||j.bottom<a);
                else if(f.tolerance=="fit")n=j.left>g&&j.right<c&&j.top>a&&j.bottom<h;
                if(n){
                    if(j.selected){
    ...
    _mouseDrag:function(d){
        ...
        if(this.options.scroll){
            ...
            if(this.scrollParent[0]!=document&&this.scrollParent[0].tagName!="HTML"){
                if(this.overflowOffset.top+this.scrollParent[0].offsetHeight-d.pageY<e.scrollSensitivity)this.scrollParent[0].scrollTop=f=this.scrollParent[0].scrollTop+e.scrollSpeed;
                ...
                if(d.pageY-b(document).scrollTop()<e.scrollSensitivity)f=b(document).scrollTop(b(document).scrollTop()-
                    e.scrollSpeed);
                else if(b(window).height()-(d.pageY-b(document).scrollTop())<e.scrollSensitivity)f=b(document).scrollTop(b(document).scrollTop()+e.scrollSpeed);
                if(d.pageX-b(document).scrollLeft()<e.scrollSensitivity)f=b(document).scrollLeft(b(document).scrollLeft()-e.scrollSpeed);
                else if(b(window).width()-(d.pageX-b(document).scrollLeft())<e.scrollSensitivity)f=b(document).scrollLeft(b(document).scrollLeft()+e.scrollSpeed)
                    }
...
_refreshItems:function(d){
    ...
    var e=this.items,f=[[b.isFunction(this.options.items)?this.options.items.call(this.element[0],d,{
        item:this.currentItem
    ...
    if(g)for(var a=g.length-1;a>=0;a--)for(var c=b(g[a]),h=c.length-1;h>=0;h--){
        ...
        if(i&&i!=this&&!i.options.disabled){
            f.push([b.isFunction(i.options.items)?i.options.items.call(i.element[0],d,{
                item:this.currentItem
...
_convertPositionTo:function(d,e){
    ...
    var f=this.cssPosition=="absolute"&&!(this.scrollParent[0]!=document&&b.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,g=/(html|body)/i.test(f[0].tagName);
    return{
        top:e.top+this.offset.relative.top*d+this.offset.parent.top*d-(b.browser.safari&&this.cssPosition=="fixed"?0:(this.cssPosition=="fixed"?-this.scrollParent.scrollTop():g?0:f.scrollTop())*d),
        left:e.left+this.offset.relative.left*d+this.offset.parent.left*d-(b.browser.safari&&
...
_generatePosition:function(d){
    ...
    return{
    top:c-
    this.offset.click.top-this.offset.relative.top-this.offset.parent.top+(b.browser.safari&&this.cssPosition=="fixed"?0:this.cssPosition=="fixed"?-this.scrollParent.scrollTop():g?0:f.scrollTop()),
    left:a-this.offset.click.left-this.offset.relative.left-this.offset.parent.left+(b.browser.safari&&this.cssPosition=="fixed"?0:this.cssPosition=="fixed"?-this.scrollParent.scrollLeft():g?0:f.scrollLeft())
    }
},
...
jQuery.effects||function(b,d){
    ...
    for(p in k)if(l[p]!=k[p])m[p]=k[p];return m
    }
    function h(l,k,m,p){
    if(typeof l=="object"){
        p=
    ...
    b.effects.explode=function(d){
        return this.queue(function(){
            ...
            for(var c=g.outerWidth(true),h=g.outerHeight(true),i=0;i<e;i++)for(var j=
                ...
                width:c/f,
                height:h/e,
                left:a.left+j*(c/f)+(d.options.mode=="show"?(j-Math.floor(f/2))*(c/f):0),
                top:a.top+i*(h/e)+(d.options.mode=="show"?(i-Math.floor(e/2))*(h/e):0),
                opacity:d.options.mode=="show"?0:1
                }).animate({
                left:a.left+j*(c/f)+(d.options.mode=="show"?0:(j-Math.floor(f/2))*(c/f)),
                top:a.top+
    ...
    b.effects.fold=function(d){
        return this.queue(function(){
            ...
            var i=b.effects.createWrapper(e).css({
                overflow:"hidden"
            }),j=g=="show"!=c,n=j?["width","height"]:["height","width"];
...
(function(b){
    b.effects.highlight=function(d){
        return this.queue(function(){
            var e=b(this),f=["backgroundImage","backgroundColor","opacity"],g=b.effects.setMode(e,d.options.mode||"show"),a={
...
(function(b){
    b.effects.puff=function(d){
        return this.queue(function(){
            var e=b(this),f=b.effects.setMode(e,d.options.mode||"hide"),g=parseInt(d.options.percent,10)||150,a=g/100,c={
                height:e.height(),
                width:e.width()
                };
...
b.effects.size=function(d){
    return this.queue(function(){
        ...
        j=b.effects.setMode(e,d.options.mode||"effect"),n=d.options.restore||false,o=d.options.scale||"both",l=d.options.origin,k={
            height:e.height(),
            width:e.width()
            };
...
_generateMonthYearHeader:function(a,c,h,i,j,n,o,l){
    ...
    s="";
    if(n||!k)s+='<span class="ui-datepicker-month">'+o[c]+"</span>";
    else{
        o=i&&i.getFullYear()==h;
        ...
        for(var u=0;u<12;u++)if((!o||u>=i.getMonth())&&(!r||u<=j.getMonth()))s+='<option value="'+u+'"'+(u==c?' selected="selected"':"")+">"+l[u]+"</option>";s+="</select>"
        }
        p||(q+=s+(n||!(k&&
        m)?"&#xa0;":""));
    if(!a.yearshtml){
...
_size:function(){
    ...
    if(a.height==="auto")if(b.support.minHeight)this.element.css({
        minHeight:h,
        height:"auto"
    });
    else{
